...
public class IzbornikController {
	...
	@FXML
	public void otvoriPodatci() {
		VjezbeApplication.showWindow("views/podatci-view.fxml");
	}
	
	@FXML
	public void otvoriProlaznost() {
		VjezbeApplication.showWindow("views/prolaznost-view.fxml");
	}
}
